	...
	<div class="container x-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
		{#if segment === undefined}
			<div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
				...
				<p class="leading-normal text-2xl mb-8">Opiniones, comentarios, aprendizaje</p>
			</div>
...
<div class="relative -mt-12 lg:-mt-24">
	<!--<svg viewBox="0 0 1428 600" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
		<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
			...
			<g transform="translate(-4.000000, 76.000000)" fill="#FFFFFF" fill-rule="nonzero">
				<path d="M250,100 a500,250 0 1,0 1000,0 z"></path>
