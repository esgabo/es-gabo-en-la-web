...
<nav id="header" class="absolute w-full z-50 top-0 text-white">

	<div class="w-full container mx-auto flex items-center mt-0 py-0 lg:mt-2 lg:py-2">
		<div class="pl-4">
			<a class="flex toggleColour text-white no-underline hover:no-underline font-bold text-lg "  href=".">
		...
		<div class="w-full flex-grow flex items-center mt-2 lg:mt-0 text-black p-4 lg:p-0 z-20" id="nav-content">
			<ul class="list-reset flex justify-end flex-1 items-center">
				<li class="mr-0 xl:mr-3">
					<a aria-current="{segment === undefined ? 'page' : undefined}" class="text-lg inline-block text-white no-underline py-2 px-3 xl:px-4" href=".">
          <svg class="inline-block pb-1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" viewBox="0 0 512 512" width="27px" height="27px">
            ...
            <span class="hidden xl:inline-block">Inicio</span>
				...
				<li class="mr-0 xl:mr-3">
					<a aria-current="{segment === 'acerca-de-gabo' ? 'page' : undefined}" class="text-lg inline-block toggleColour text-white no-underline py-2 px-3 xl:px-4" href="acerca-de-gabo">
          ...
          <span class="hidden xl:inline-block">Acerca de</span>
				...
				<li class="mr-0 xl:mr-3">
					<a aria-current="{segment === 'contacto' ? 'page' : undefined}" class="text-lg inline-block toggleColour text-white no-underline py-2 px-3 xl:px-4" href="contacto">
        ...
        <li class="mr-0 xl:mr-3">
          <a aria-current="{segment === 'blog' ? 'page' : undefined}" rel=prefetch class="text-lg inline-block toggleColour text-white no-underline py-3 px-3 xl:px-4" href="blog">
